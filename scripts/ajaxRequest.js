...
function requestSummonerData(summonerName, callbackFn) {
...
function searchSummoner() {
    ...
    summonerData = requestSummonerData(summonerName, function (summonerData) {
        $.getJSON(CORS_PROXY + "https://euw1.api.riotgames.com/lol/match/v3/matchlists/by-account/" + summonerData.accountId + "/recent?api_key=RGAPI-06207fa7-aa25-4623-bf84-23ec9dde9aee",
            function (data) {
                console.log(data);
